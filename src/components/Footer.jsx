        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr] gap-10 md:gap-8 mb-12">
          ...
          <div>
            <a href="#home" className="flex items-center gap-1.5 mb-4">
              ...
              <span className="font-semibold text-white tracking-tight">Yashoda Dental</span>
            </a>
            <p className="text-sm text-gray-400 leading-relaxed max-w-sm mb-5">
              A neighbourhood dental clinic in Indore built on honest care, fair 
              pricing, and long-term relationships with every patient.
            </p>
            <a
              href="https://instagram.com/yashodadental"
              target="_blank"
          ...
          <div>
            ...
            <ul className="space-y-3.5 text-sm">
              <li className="flex items-start gap-2.5">
                <MapPin size={15} className="text-coral mt-0.5 shrink-0" />
                <span>42 Elite Complex, AB Road,<br />Indore, MP 452001</span>
              </li>
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a href="mailto:hello@yashodadental.in" className="hover:text-white transition-colors">hello@yashodadental.in</a>
              </li>
            </ul>
          </div>
